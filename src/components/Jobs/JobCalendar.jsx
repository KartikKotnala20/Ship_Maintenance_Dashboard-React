...
const JobCalendar = () => {
  ...
  return (
    <div className="p-4 bg-[#F2F9FF] min-h-screen">
      <h2 className="text-xl font-bold mb-4 text-center md:text-left">Maintenance Calendar</h2>
      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-8 md:gap-12">
        ...
        {/* Jobs list container */}
        <div className="relative flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg p-6 w-full max-w-md md:max-w-lg">
          ...
          {jobsForSelected.length === 0 ? (
            <p className="text-gray-500 pl-2">No jobs scheduled.</p>
          ) : (
